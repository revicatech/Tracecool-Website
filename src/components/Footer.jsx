        ...
        <div className="flex flex-col lg:flex-row gap-16 py-20">
          ...
          <div className="lg:w-5/12">
            ...
            <div className="flex gap-3 mb-10">
              {socialPaths.map((d, i) => (
                <a key={i} href="#" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:border-accent-light hover:bg-accent/10 transition-all">
